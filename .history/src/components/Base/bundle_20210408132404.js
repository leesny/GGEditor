!(function (e, t) {
  ...
  return (function (e) {
      ...
      function f(e, t) {
        for (var n, r, o, i, a, c = 1 / 0, u = 0; u < t.length - 1; u++) {
          var s = l(t, u),
            f = void 0;
          if (
            d((f = s ? { x: t[u].x, y: e.y } : { x: e.x, y: t[u].y }), t, u)
          ) {
            var h =
              ((i = e),
              (a = f),
            ...
            (r = [
              {
                ...
                value: function (e, t) {
                  ...
                  if (1 !== e.length || e[0].isNode || e[0].isGroup) {
                    ...
                    (n = d.getRectByBox(r, t, f.nodeDelegationStyle)).set(
                      "capture",
                      !1
                    );
                  } else
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    ...
                    i[1] > o - 100 &&
                      d.mat3.translate(e, e, [0, o - 100 - i[1]]),
                    i[0] > r - 100 &&
                      d.mat3.translate(e, e, [r - 100 - i[0], 0]),
                    !0
                  );
                },
              },
          ...
          getTypeAndChar: function (e) {
            ...
            for (var n in ((e = "" + e), u))
              for (var r in ((t = n), u[n]))
                if (r === e) return { type: t, character: u[n][r] };
            return {};
          },
          ...
          delegateEvent: function (e, t, n, r) {
            return s.addEventListener(e, t, function (t) {
              for (var o = t.target || t.srcElement; o !== e; )
                s.matches(o, n) &&
                  r.call(o, Array.prototype.slice.call(arguments)),
                  (o = o.parentNode);
            });
          },
          Palettes: c,
                ...
                value: function (e) {
                  ...
                  return t[n - 1]
                    ...
                    : this._getVerticalMoveItem(
                        ...
                        function (e, t, n) {
                          return (
                            e.centerY < t.centerY && n <= e.maxX && n >= e.minX
                          );
                        },
                        function (e, t) {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this.get("_graph"),
                    n = e.model,
                    r = t.find(n.parent);
                  r.getModel().collapsed && t.update(r, { collapsed: !1 }),
                    ...
                    this.on("beforeitemselected", function (t) {
                      var n = t.item,
                        r = e
                          .get("_graph")
                          .getShapeObj(n)
                          .getSelectedOutterStyle(n);
                      n.isNode
                        ? e.addOutterShape(n, r)
                        : n.isGroup && e.addOutterShape(n, r);
                    }),
    ...
    function (e, t, n) {
      ...
      function u(e) {
        ...
        (this.snapShot = t.save()),
          ...
          this.method &&
            (i.isString(this.method) ? t[this.method]() : this.method(e));
      }
      function s(e) {
        var t = e.getCurrentPage();
      ...
      (a.list = []),
        ...
        (a.execute = function (e, t, n) {
          ...
          return (
            r.enable(t) &&
              (r.init(),
              r.queue &&
                (o.queue.splice(o.current, o.queue.length - o.current, r),
                (o.current += 1)),
        ...
        a.registerCommand("copyAdjacent", {
          ...
          execute: function (e) {
            ...
            1 === this.executeTimes &&
              ((this.addIds = [c.id, u.id]), (this.page = n));
          },
          back: function () {
        ...
        a.registerCommand("update", {
          ...
          execute: function (e) {
            ...
            1 === this.executeTimes &&
              ((this.originModel = i.getContrast(
                r.getModel(),
                this.updateModel
              )),
              (this.page = t)),
        ...
        a.registerCommand("pasteHere", {
          ...
          method: function (e) {
            var t = e.getCurrentPage(),
              ...
              o = this.copyCenterBox
                ? this.copyCenterBox
                : e.get("copyCenterBox"),
              a = this.contextmenuPoint
                ? this.contextmenuPoint
                : e.get("contextmenuPoint");
            t.clearSelected(),
      ...
      function o(e) {
        ...
        null != s &&
          ...
          l
            ...
            : n.css({ cursor: "row-resize" }));
      }
      function i(e) {
        var t = e.graph,
          n = e.bpmn,
          r = e.item;
        r._cursor && n.css({ cursor: r._cursor }),
          delete r._cursor,
          t.update(r, { hold: void 0 });
      }
      function a(e, t) {
        var n = t.item;
          ...
          return (
            ...
            (r = [
                ...
                value: function (e) {
                  ...
                  this.setCommandDOMenable(),
                    ...
                    e.on("mousedown", function () {
                      t.getComponentsByType("contextmenu").forEach(function (
                        e
                      ) {
                        e.hide();
                      });
                    ...
                    e.on("contextmenu", function (n) {
                      ...
                      c &&
                        !c.isSelected &&
                        (e.clearSelected(), e.setSelected(n.item, !0)),
              ...
              },
              {
                ...
                value: function (e, t) {
                  for (
                    var n = e.shortcutCodes,
                      r = s.getKeyboradKey(t),
                      o = !1,
                      i = 0;
                    i < n.length;
                    i++
                  ...
                  e.getGraph().on("keydown", function (e) {
                    ...
                    for (
                      ...
                      if (t._shortcutEnable(c, o))
                        return t.executeCommand(c.name), !1;
                    }
                  });
                },
              },
    ...
    function (e, t, n) {
      ...
      !(function (o) {
        ...
        function A(e, t) {
          t = t || 6;
          for (
            var n = f(e).toHsv(), r = n.h, o = n.s, i = n.v, a = [], c = 1 / t;
            t--;
        ...
        (f.prototype = {
          ...
          setAlpha: function (e) {
            return (
              (this._a = j(e)), (this._roundA = u(100 * this._a) / 100), this
            );
          },
          toHsv: function () {
    ...
    function (e, t, n) {
      ...
      (a.AUGMENT = {
        ...
        showGrid: function (e) {
          ...
          n ||
            (e ? i.isObject(e) && this.set("grid", e) : this.set("grid", !0),
            this._initGrid()),
            ...
            r(t, this, "click"),
              ...
              t.on("afterviewportchange", function (t) {
                e.emit("afterviewportchange", t),
                  t.updateMatrix[0] !== t.originMatrix[0] &&
                    e.emit("afterzoom", t);
              }),
    ...
    function (e, t, n) {
      var r = n(4),
        o = {
          CFG: { activeable: !0, _activedCache: {} },
          INIT: "_initActived",
        };
      (o.AUGMENT = {
            ...
            },
            {
              ...
              value: function (e, t, n) {
                ...
                if (
                  ...
                  l.each(r, function (e) {
                    e[4].isVisible() &&
                      (h.push(d(e, a)), h.push(d(e, c)), h.push(d(e, u)));
                  }),
                  l.each(o, function (e) {
                    e[4].isVisible() &&
                      (g.push(d(e, s)), g.push(d(e, c)), g.push(d(e, f)));
                  }),
                  h.sort(function (e, t) {
                    return e.dis - t.dis;
                  }),
        ...
        beginEditLabel: function (e) {
          ...
          if ((r.isString(e) && (e = n.find(e)), e && !e.destroyed && t)) {
            ...
            if (((t.focusItem = e), i)) {
              ...
              (t.innerHTML = ""),
                t.css({ "min-width": "auto", "min-height": "auto" });
          ...
          n.behaviourOn(
            ...
            i.throttle(function (r) {
              ...
              if (c) {
                ...
                var l = [],
                  d = n.getMatrix();
                var whxx = a.wheelDeltaX || a.deltaX;
                var whyy = a.wheelDeltaY || a.deltaY;
                i.mat3.translate(l, d, [
                  whxx * o.wheelPanRatio,
                  whyy * o.wheelPanRatio,
                ]),
        ...
        t.behaviourOn("dragstart", function (r) {
          if (2 !== r.button && r.item && (r.item.isNode || r.item.isGroup)) {
            var o,
              i = r.item;
            if (
              (o = (o = i.isSelected ? e.getSelected() : [i]).filter(function (
                e
              ) {
              ...
              t.emit("beforepanitem", { items: o }),
                t.emit("beforeshowdelegation", { items: o });
    ...
    function (e, t, n) {
      ...
      e.exports = {
        dragingEdgeEndPoint: function (e) {
          ...
          var d = r
            .getShapeObj("edge", n)
            .getPathByPoints({ points: l, source: c, target: u });
        ...
        anchorHasBeenLinked: function (e, t) {
          ...
          return (
            n.forEach(function (t) {
              var n = t.getModel();
              n.source !== e.id ||
                i.isNil(n.sourceAnchor) ||
                r.push(n.sourceAnchor),
                n.target !== e.id ||
                  i.isNil(n.targetAnchor) ||
                  r.push(n.targetAnchor);
            }),
                  ...
                  this._clearAnchor(e),
                    f.each(i, function (i, a) {
                      if (!n || -1 !== n.indexOf(a)) {
                        var c,
                          u = t.addShape("marker", {
                            attrs: o({ symbol: "circle" }, d.anchorPointStyle, {
                              x: i.x,
                              y: i.y,
                            }),
                            freezePoint: i,
        ...
        function (e) {
          ...
          t.behaviourOn("drop", function () {
            ...
            if (n) {
              ...
              var d = e.editor;
              t.emit("panitemend"),
                !d || e.getSignal("dragaddnodetogroup")
                  ? f()
                  : d.executeCommand(f);
            }
            function f() {
          ...
          function p(g) {
            if (r) {
              ...
              if (m) {
                var v = e.editor;
                v
                  ? v.executeCommand("update", { itemId: y, updateModel: p })
                  : h.update(y, p);
              }
        ...
        function (e) {
          ...
          c.behaviourOn("canvas:mouseenter", function (c) {
            ...
            c.behaviourOn("mouseup", function (t) {
              if (n) {
                ...
                n.remove(),
                  ...
                  e.focusGraphWrapper(),
                  u
                    ? u.executeCommand("add", { type: "node", addModel: a })
                    : c.add(r, a),
            ...
            c.behaviourOn("canvas:mouseleave", function () {
              n &&
                (e.clearAlignLine(), n.remove(), c.draw(), e.cancelAdd(), s());
            });
        },
        ["processPanItem"]
      );
        ...
        a.behaviourOn("drag", function (u) {
          ...
          a.on("drop", function (e) {
            n &&
              t &&
              !e.shape &&
              (a.update(t, { parent: void 0 }),
              a.update(n, { style: void 0 }),
              u());
          }),
              ...
              if (u)
                t.getNodes().forEach(function (t) {
                  ...
                  o.dropUpdateEdge({
                    ...
                    (l
                      ? l.executeCommand("add", { type: "edge", addModel: c })
                      : t.add("edge", c)),
                  t.draw(),
                  e.endAdd(),
                  n();
          ...
          n.behaviourOn("mousemove", function (r) {
            ...
            if (t) {
              var s = t.getBBox(),
                ...
                d = n.getMatrix()[0];
              a !== t &&
                l > s.width / 2 + o.orbitGap / d &&
                (e.hideOrbit(), (t = void 0)),
    ...
    function (e, t, n) {
      ...
      function s(e, t, n) {
        var o = e[0],
          ...
          s = (function (e, t, n, r) {
            return [
              n && n.bbox ? a(n, e, t, r) : u(e, t),
              r && r.bbox ? a(r, t, e, n) : u(t, e),
            ];
          })(o, i, t, n),
          l = ["C"],
          d = [c];
          ...
          i.behaviourOn("beforeshowdelegation", function () {
            ...
            i.behaviourOn("node:dragstart", function (e) {
              if (2 !== e.button) {
                var r = e.item;
                !(t = r.getModel()).parent ||
                e.shape.isCollapsedButton ||
                e.shape.isExpandedButton
                  ? c()
            ...
            i.behaviourOn("itempanning", function (t) {
              if (!t.shape || !t.shape.isPlaceholder) {
                ...
                if (
                  (r &&
                    (n
                      ? r.id !== n.id && i.remove(i.find(r.id))
                      : i.remove(i.find(r.id))),
                  (r = n),
                  n)
                ) {
                  var a = n.parent;
      ...
      i.registerNode("mind-base", {
        ...
        drawExpandedButton: function (e) {
          var t = e.getKeyShape().getBBox(),
            ...
            o = n.addShape("path", {
              attrs: r({ path: a.getRectPath(0, 0, 16, 7, 3) }, u),
            }),
            i = o.getBBox(),
        ...
        drawCollapsedButton: function (e) {
          var t = e.getKeyShape().getBBox(),
            n = e
              .getGraphicGroup()
              .addShape("path", {
                attrs: r({ path: a.getCollapsedButtonPath() }, s),
              }),
            o = n.getBBox(),
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (!e)
                    throw new Error(
                      "please set the container for the toolbar !"
                    );
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (!e)
                    throw new Error(
                      "please set the container for the tontextmenu !"
                    );
                  u.isString(e) && (e = document.getElementById(e));
                  var t = e.getElementsByClassName("command");
      ...
      n(12).registerBehaviour(
        ...
        function (e) {
          ...
          n.behaviourOn("edge:mouseenter", function (t) {
            !i &&
              t.item &&
              ((a = t.item), u({ graph: n, bpmn: e, ev: t, backUpCursor: !0 }));
          }),
          ...
          n.behaviourOn("mousemove", function (n) {
            ...
            if (t) {
              var a = t.getBBox(),
                ...
                d = a.maxY + c;
              (r < u || i < s || r > l || i > d) &&
                (e.hideArrowController(), (t = void 0));
            }
          });
      });
    },
    ...
    function (e, t, n) {
      ...
      function a(e) {
              ...
              return {
                ...
                joint: {
                  x: i
                    ...
                    : t.minX +
                      4 -
                      Math.sqrt(16 - Math.pow(t.minY + 4 - o.y, 2)),
                  y: i
                    ? o.y > t.centerY
                      ? t.maxY -
                        4 +
                        Math.sqrt(16 - Math.pow(t.minX + 4 - o.x, 2))
                      : t.minY +
                        4 -
                        Math.sqrt(16 - Math.pow(t.minX + 4 - o.x, 2))
                    : o.y,
              ...
              return {
                ...
                joint: {
                  x: i
                    ...
                    : t.minX +
                      4 -
                      Math.sqrt(16 - Math.pow(o.y - t.maxY + 4, 2)),
                  y: i
                    ? o.y > t.centerY
                      ? t.maxY -
                        4 +
                        Math.sqrt(16 - Math.pow(o.x - t.maxX + 4, 2))
                      : t.minY +
                        4 -
                        Math.sqrt(16 - Math.pow(o.x - t.maxX + 4, 2))
                    : o.y,
              ...
              return {
                ...
                joint: {
                  x: i
                    ...
                    : o.x > t.centerX
                    ? o.y < t.centerY
                      ? ((o.y - t.minY) * (t.maxX - t.centerX)) /
                          (t.centerY - t.minY) +
                        t.centerX
                      : ((t.maxY - o.y) * (t.maxX - t.centerX)) /
                          (t.maxY - t.centerY) +
                        t.centerX
                    : o.y < t.centerY
                    ? t.centerX -
                      ((o.y - t.minY) * (t.centerX - t.minX)) /
                        (t.centerY - t.minY)
                    : t.centerX -
                      ((t.maxY - o.y) * (t.centerX - t.minX)) /
                        (t.maxY - t.centerY),
                  y: i
                    ? o.y > t.centerY
                      ? o.x < t.centerX
                        ? ((o.x - t.minX) * (t.maxY - t.centerY)) /
                            (t.centerX - t.minX) +
                          t.centerY
                        : ((t.maxX - o.x) * (t.maxY - t.centerY)) /
                            (t.maxX - t.centerX) +
                          t.centerY
                      : o.x < t.centerX
                      ? t.centerY -
                        ((o.x - t.minX) * (t.centerY - t.minY)) /
                          (t.centerX - t.minX)
                      : t.centerY -
                        ((t.maxX - o.x) * (t.centerY - t.minY)) /
                          (t.maxX - t.centerX)
                    : o.y,
                },
              };
        ...
        return i
          ? o.x < t.centerX
            ? {
                added: { x: o.x, y: t.centerY },
                joint: { x: t.minX, y: t.centerY },
              }
            : {
                added: { x: o.x, y: t.centerY },
                joint: { x: t.maxX, y: t.centerY },
              }
          : o.y < t.centerY
          ? {
              added: { x: t.centerX, y: o.y },
              joint: { x: t.centerX, y: t.minY },
            }
          : {
              added: { x: t.centerX, y: o.y },
              joint: { x: t.centerX, y: t.maxY },
            };
      }
      var c = n(20);
      o.a.registerEdge("bpmn-base", {
        getPath: function (e) {
          ...
          if (o.edgeMoved && o.lastMouse) {
            ...
            if (
              (0 === g &&
                n &&
                ((p[0] = l),
                s && (p.splice(1, 0, s), (e.model.hold.index += 1))),
              r)
            ) {
              var v = a({
                bbox: r.getBBox(),
          ...
          return (
            (o.nodeMoved = void 0),
            {
              path: this.getPathByPoints({ points: o.controlPoints }),
              helpLine: t,
            }
          );
        },
        draw: function (e) {
          ...
          if (null != n.hold) {
            ...
            t.addShape("circle", {
              attrs: { x: s.x, y: s.y, r: 3, fill: "rgb(0,182,239)" },
            });
          }
          return (
